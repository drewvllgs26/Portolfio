...
// open modal when clicking on portfolio items without links
document.querySelectorAll('.project-item a[href="#"]').forEach(link => {
  link.addEventListener('click', (e) => {
    e.preventDefault();
    const modalContainer = document.querySelector("[data-portfolio-modal]");
...
document.querySelector("[data-portfolio-modal]").addEventListener("click", (e) => {
  if (e.target === e.currentTarget) {
    const modalContainer = e.currentTarget;
    const overlay = modalContainer.querySelector("[data-overlay]");
    modalContainer.classList.remove("active");
    overlay.classList.remove("active");
  }
